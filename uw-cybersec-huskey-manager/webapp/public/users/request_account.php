...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // REMEDIATION: Cryptographic Hashing
    $plain_password  = $_POST['password'];
    $hashed_password = password_hash($plain_password, PASSWORD_DEFAULT);

    // REMEDIATION: Prepared Statements to prevent SQLi
    ...
    if ($stmt->execute()) {
        ...
        $error_message = 'Error: Account request failed. Username might already exist.';
    }
    $stmt->close();
    $conn->close();
}
